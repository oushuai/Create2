...
alert("该电话号码不合法！");
  ...
  <br />
  <br />
  <s:form action="teacherAdd.action" method="post" theme="simple" onsubmit="return check();">
  ...
  <td>
  	<s:textfield name="teacher.name" label="姓名" size="10" maxlength="10" onblur="check()" id="name"/>
  </td>
  </tr>
   <tr>
  <td align="right">
  ...
  <td>
  	<s:textfield name="teacher.phone" label="电话" size="11" maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')" id="phone"/>
  </td>
  </tr>
  <tr>
   <td align="right">
  ...
  <td>
  	<s:select list="{'讲师','副教授','教授'}" value="'讲师'" name="teacher.rank" label="职称"></s:select>
  </td>
  </tr>
  <tr>
  <td align="right">
