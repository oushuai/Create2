...
<h1 align="center">和创新性实验计划项目中期检查报告书</h1>
  ...
  <s:form action="mediumUpdate.action" method="post" theme="simple">
...
<tr><td align="center">填报日期：</td><td> <s:textfield name="medium.tianbao" size="50" maxlength="50" required="required" /></td></tr>
...
<tr><td colspan="2" width="100%">五、存在问题、建议及需要说明的情况。<br>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日
  	...
  	<s:hidden name="medium.jindu"></s:hidden>
