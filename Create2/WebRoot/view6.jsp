...
<h1 align="center">项目结题报告</h1>
  ...
  <s:form action="view66.action" method="post" theme="simple">
...
<tr><td align="center">填表日期：</td><td> <s:textfield name="jieti.tianbiao" size="50" maxlength="50" disabled="true" required="required" id="tianbiao"/></tr>
</table>
...
<td><s:textfield name="jieti.num1" required="required" disabled="true" size="10" maxlength="10" id="num1"/></td>
...
<tr><td colspan="7" width="100%">项目指导教师对结题的意见，包括对项目研究工作和研究成果的评价等。<br>
 ...
 <s:radio list="{'二级学院审核通过，等待校级评委审核','二级学院审核不通过'}" name="jieti.jindu" disabled="true" required="required" label="审核意见" size="20" maxlength="20" id="jindu" />
 </td>
</tr>
 <tr><td colspan="7" width="100%">所在系（院）对结题的意见，包括对项目研究工作和研究成果的评价等。<br>
 <s:textarea name="jieti.yijian1"  cols="68" rows="10" size="1000" maxlength="1000" disabled="true" id="yijian1"/></td>
 </tr>
 </table>
...
<tr><td colspan="5" width="100%">审核意见<br>
<s:radio list="{'校级评委审核通过','校级评委审核不通过'}" name="jieti.jindu1" required="required" label="审核意见" size="20" maxlength="20" id="jindu1" />
 </td>
</tr>
<tr> 
 <td><s:textarea name="jieti.yijian2"  cols="68" rows="10" size="1000" maxlength="1000" id="yijian2"/></td>
</tr>
 <tr> 
  <td>
   <%
   ...
   String jtime2 = simpleDateFormat.format(currentTime).toString();  
     %>
  	<input name="jieti.jtime2" id="jtime2" type="hidden" value="<%=jtime2 %>"/>
  	...
  	<s:hidden name="jieti.jindu"></s:hidden>
  	<s:hidden name="jieti.jtime1"></s:hidden>
