...
<html>
  ...
  <body>
 <div align="center">
  <h1 style="padding-top:20px;">项目成果审核</h1>
  ...
  <hr>
    ...
    <table width="750px" align="center" border="0">
  		<tr>
  		<td>
  			<form action="shenhe9.action" method="post">
	...
	<table width="750px" align="center" border="0">
  	...
  	<table width="750px" align="center" border="1">
  		...
  		<tr align="center" class="tr1">
			...
			<td align="center">
			 <a href="view9.action?tongji.pname=<s:property value="#tongji.pname"/>">审核</a> 
			</td>
		</tr>
		</s:iterator>
	</table>
			...
			<s:set name="page" value="#request.page"></s:set>
				<s:if test="#page.totalSize!=0">
  				...
  				<s:if test="#page.hasFirst">
					<a href="shenhe9.action?pageNow=1&tongji.pname=<s:property value="tongji.pname"/>">首页</a>
				</s:if>
				<s:if test="#page.hasPre">
					<a href="shenhe9.action?pageNow=<s:property value="#page.pageNow-1"/>&tongji.pname=<s:property value="tongji.pname"/>">上一页</a>
				</s:if>
				<s:if test="#page.hasNext">
					<a href="shenhe9.action?pageNow=<s:property value="#page.pageNow+1"/>&tongji.pname=<s:property value="tongji.pname"/>">下一页</a>
				</s:if>
				<s:if test="#page.hasLast">
					<a href="shenhe9.action?pageNow=<s:property value="#page.totalPage"/>&tongji.pname=<s:property value="tongji.pname"/>">尾页</a>
				</s:if>
		</td>
  		</tr>
  	</table>
