	...
	<table width="1000" align="center" border="0">
  	...
  	<table width="1000" align="center" border="1">
  		...
  		<tr align="center">
			...
			<s:property value="#jieti.jtime1"/></li>
			</td>
			
			<td align="center"> 
			 <a href="view5.action?jieti.pname=<s:property value="#jieti.pname"/>">审核</a> 
			</td>
		</tr>
		</s:iterator>
	</table>
			...
			<s:set name="page" value="#request.page"></s:set>
				<s:if test="#page.totalSize!=0">
  				...
  				<s:if test="#page.hasFirst">
					<a href="shenhe5.action?pageNow=1&jieti.pname=<s:property value="jieti.pname"/>">首页</a>
				</s:if>
				<s:if test="#page.hasPre">
					<a href="shenhe5.action?pageNow=<s:property value="#page.pageNow-1"/>&jieti.pname=<s:property value="jieti.pname"/>">上一页</a>
				</s:if>
				<s:if test="#page.hasNext">
					<a href="shenhe5.action?pageNow=<s:property value="#page.pageNow+1"/>&jieti.pname=<s:property value="jieti.pname"/>">下一页</a>
				</s:if>
				<s:if test="#page.hasLast">
					<a href="shenhe5.action?pageNow=<s:property value="#page.totalPage"/>&jieti.pname=<s:property value="jieti.pname"/>">尾页</a>
				</s:if>
		</td>
  		</tr>
  	</table>
