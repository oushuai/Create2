...
<html>
  ...
  <body>
   <div align="center">
  <h1 style="padding-top:20px;">二级学院审核</h1>
	...
	<table width="920px" align="center" border="0">
  	...
  	<table width="920px" align="center" border="1">
  		...
  		<tr align="center" class="tr1">
			...
			<td><s:property value="#projectinformation1.jindu"/>
			    <s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm}', {#projectinformation1.stime1})}"/>
			</td>
			<td align="center">
		 
			 <a href="view1.action?projectinformation1.pname=<s:property value="#projectinformation1.pname"/>">审核</a> 
			</td>
		</tr>
		</s:iterator>
	</table>
			...
			<s:set name="page" value="#request.page"></s:set>
				<s:if test="#page.totalSize!=0">
  				...
  				<s:if test="#page.hasFirst">
					<a href="shenhe1.action?pageNow=1&projectinformation1.pname=<s:property value="projectinformation1.pname"/>">首页</a>
				</s:if>
				<s:if test="#page.hasPre">
					<a href="shenhe1.action?pageNow=<s:property value="#page.pageNow-1"/>&projectinformation1.pname=<s:property value="projectinformation1.pname"/>">上一页</a>
				</s:if>
				<s:if test="#page.hasNext">
					<a href="shenhe1.action?pageNow=<s:property value="#page.pageNow+1"/>&projectinformation1.pname=<s:property value="projectinformation1.pname"/>">下一页</a>
				</s:if>
				<s:if test="#page.hasLast">
					<a href="shenhe1.action?pageNow=<s:property value="#page.totalPage"/>&projectinformation1.pname=<s:property value="projectinformation1.pname"/>">尾页</a>
				</s:if>
		</td>
  		</tr>
  	</table>
