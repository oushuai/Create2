...
<h1 align="center">项目申报表</h1>
  ...
  <s:form action="projectinformation1Update.action" method="post" theme="simple">
...
<td><s:radio list="{'男','女'}" required="required" name="projectinformation1.sex1" label="性别"></s:radio></td>
...
<td><s:radio list="{'男','女'}" required="required" name="projectinformation1.sex2" label="性别"></s:radio></td>
...
<td><s:radio list="{'男','女'}" name="projectinformation1.sex3" label="性别"></s:radio></td>
...
<td><s:radio list="{'男','女'}" name="projectinformation1.sex4" label="性别"></s:radio></td>
...
<tr><td colspan="5" width="100%">指导教师意见<br>
 ...
 <tr> 
  <td><s:hidden name="projectinformation1.jindu"></s:hidden>  
      <s:hidden name="projectinformation1.stime1"></s:hidden>
      <s:hidden name="projectinformation1.jindu1"></s:hidden>  
      <s:hidden name="projectinformation1.stime2"></s:hidden>
      <s:hidden name="projectinformation1.jindu2"></s:hidden>  
      <s:hidden name="projectinformation1.stime3"></s:hidden>
    <s:hidden name="projectinformation1.ptime1"></s:hidden> 
    <s:hidden name="projectinformation1.yuanxi"></s:hidden>
  </td>
  </tr>
