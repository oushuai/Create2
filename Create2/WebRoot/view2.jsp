...
<h1 align="center">项目申报表</h1>
  ...
  <s:form action="view22.action" method="post" theme="simple">
...
<tr><td colspan="5" width="100%">审核意见<br>
 ...
 <s:radio list="{'校级评委推荐为校级','校级评委推荐为省级','校级评委审核未通过'}" name="projectinformation1.jindu1" required="required" label="审核意见" size="20" maxlength="20" id="jindu1" />
 </td>
</tr>
 <tr> 
  <td>
   ...
   String stime2 = simpleDateFormat.format(currentTime).toString();  
     %>
  	<input name="projectinformation1.stime2" id="stime2" type="hidden" value="<%=stime2 %>"/>
  	...
  	<s:hidden name="projectinformation1.stime1" id="stime1"></s:hidden>
  	<s:hidden name="projectinformation1.jindu" id="jindu"></s:hidden>
