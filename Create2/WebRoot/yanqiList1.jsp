...
<html>
  ...
  <body>
  <div align="center">
  <h1 style="padding-top:20px;">项目延期报告</h1>
  ...
  <hr>
    ...
    <table width="1000" align="center" border="0">
  		<tr>		
  		<td>
  			<a href="yanqiAddView.action" target="rightFrame"><img alt="" src="./images/add.jpg" ></a>
  	...
  	<table width="1000" align="center" border="1">
  		...
  		<tr align="center" class="tr1">
			...
			<s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm}', {#yanqi.ytime1})}"/></li></td>			
			<td align="center">
			...
			<s:set name="page" value="#request.page"></s:set>
				<s:if test="#page.totalSize!=0">
  				...
  				<s:if test="#page.hasFirst">
					<a href="yanqiList1.action?pageNow=1&yanqi.pname=<s:property value="yanqi.pname"/>">首页</a>
				</s:if>
				<s:if test="#page.hasPre">
					<a href="yanqiList1.action?pageNow=<s:property value="#page.pageNow-1"/>&yanqi.pname=<s:property value="yanqi.pname"/>">上一页</a>
				</s:if>
				<s:if test="#page.hasNext">
					<a href="yanqiList1.action?pageNow=<s:property value="#page.pageNow+1"/>&yanqi.pname=<s:property value="yanqi.pname"/>">下一页</a>
				</s:if>
				<s:if test="#page.hasLast">
					<a href="yanqiList1.action?pageNow=<s:property value="#page.totalPage"/>&yanqi.pname=<s:property value="yanqi.pname"/>">尾页</a>
				</s:if>
		</td>
  		</tr>
  	</table>
