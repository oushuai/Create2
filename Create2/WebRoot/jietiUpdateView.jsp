...
<h1 align="center">项目结题报告</h1>
  ...
  <s:form action="jietiUpdate.action" method="post" theme="simple">
...
<tr><td align="center" colspan="2">填表日期：</td><td colspan="5"> <s:textfield name="jieti.tianbiao" size="50" maxlength="50" required="required" id="tianbiao"/></td></tr>
</table>
...
<tr><td colspan="7" width="100%">学校对项目研究的任务、目标和方法和研究成果水平等进行评价，是否结题。<br>
 <s:textarea name="jieti.yijian2"  cols="68" rows="10" size="1000" disabled="true" maxlength="1000" id="yijian2"/></td>
  	...
  	<s:hidden name="jieti.yijian1"></s:hidden>
  	<s:hidden name="jieti.yijian2"></s:hidden>
