...
<h1 align="center">项目申报表</h1>
  ...
  <s:form action="view33.action" method="post" theme="simple">
...
<tr><td colspan="5" width="100%">审核意见<br>
 ...
 <s:radio list="{'校级项目已立项','专家评委推荐为省级','专家评委推荐为国家级'}" name="projectinformation1.jindu2" required="required" label="审核意见" size="20" maxlength="20" id="jindu2" />
 </td>
</tr>
 <tr> 
  <td>
   ...
   String stime3 = simpleDateFormat.format(currentTime).toString();  
     %>
  	<input name="projectinformation1.stime3" id="stime3" type="hidden" value="<%=stime3 %>"/>
